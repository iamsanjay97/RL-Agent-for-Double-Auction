VidyutVanika21 (master branch)
=======================

This branch contains a advanced tariff heuristic method, which is inspired by the idea of maintaining the market-share between specific bounds similar to TUC-TAC. This strategy is proved to be effective in PowerTAC2021.
